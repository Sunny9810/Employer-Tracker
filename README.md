...
## Description:
 ...
 The interfaces allows developers and even non-developers to easily view and interact with information through the command-line of the application stored in an SQL Employee Tracker database.
...
## Usage Instructions
1. Open the content management systems (CMS) named  "Employer - Tracker".
...
## Repository Link:
[Repository Link 'Click Here'.](https://github.com/Sunny9810/Employer-Tracker.git)

## Screenshots/Walkthroug Video
![](./assets/mysql..mp4)
